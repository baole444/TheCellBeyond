...
public class Grid extends Component {
    ...
    public void update(float dt) {
        Vector2f viewPos = Window.getScene().viewport().position;
        Vector2f projectSize = Window.getScene().viewport().loadProjectSize();
        ...
        int countVertical = (int)(projectSize.x / Settings.GRID_WIDTH) + 2;
        int countHorizontal = (int)(projectSize.y / Settings.GRID_HEIGHT) + 2;

        int height = (int)projectSize.y + Settings.GRID_HEIGHT * 2;
        int width = (int)projectSize.x + Settings.GRID_WIDTH * 2;
