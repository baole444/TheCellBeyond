...
public class EditorTileMapGrid extends Component implements NotSerializeComponent {
    ...
    public void editorUpdate(float dt) {
        ...
        float width = (int) (projectSize.x * totalZoom.x) + gridWorldSize.x * 5;
        float height = (int) (projectSize.y * totalZoom.y) + gridWorldSize.y * 5;

        int countVertical = (int) (projectSize.x * totalZoom.x / gridWorldSize.x) + 2;
        int countHorizontal = (int) (projectSize.y * totalZoom.y / gridWorldSize.y) + 2;
